...
<PropsTable rows={[
  { name: 'alpha', type: 'boolean', default: 'true', description: 'Whether to include the alpha channel in the hex value. Set to false to display only the 6-digit RGB hex.' },
]} />

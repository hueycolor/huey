...
The core package works independently of any framework. If you only need color parsing, conversion, and manipulation without UI components, see the [@hueycolor/core docs](/overview/core/).
